...
**Your Answers here:**
<br> 
1. The data of Apple returns are downloaded from Yahoo through the file "dataSet1.R", and are included in the variable "mytickers"
<br>
...
<br>
3. In the file "dataSet1.R" we have to add in the line mytickers "YHOO", save and run the file again. Statistics for Yahoo:
